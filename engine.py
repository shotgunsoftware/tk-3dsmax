...
try:
    ...
    raise Exception(
        "Shotgun: Could not import Py3dsMax - in order to run this engine, "
...
class MaxEngine(tank.platform.Engine):
    ...
    def pre_app_init(self):
        ...
        try:
            ...
            ver_year = int(2000 + (math.ceil(max_major_version / 1000.0) - 2))
    ...
    def post_app_init(self):
        ...
        menu_bg_name = (
            "menu_bg_light.png"
            if max_major_version in [14000, 15000]
            else "menu_bg.png"
        )
    ...
    def destroy_engine(self):
        ...
        menu_script = os.path.join(
            self.disk_location, "resources", "destroy_menu_bar.ms"
        )
        mxs.fileIn(menu_script)
    ...
    def max_callback_work_area_menu(self, pos):
        ...
        self._menu_generator.render_work_area_menu(
            button_center_from_left, button_center_from_top
        )
    ...
    def max_callback_apps_menu(self, pos):
        ...
        # call out to render the menu bar
        self._menu_generator.render_apps_menu(
            button_center_from_left, button_center_from_top
        )
    ...
    def __launch_blur_dialog(
        self, title, bundle, widget_class, is_modal, *args, **kwargs
    ):
        """
    ...
    def show_dialog(self, title, bundle, widget_class, *args, **kwargs):
        ...
        res = self.__launch_blur_dialog(
            title, bundle, widget_class, False, *args, **kwargs
        )
        if not res:
            return
        status, widget = res
    ...
    def show_modal(self, title, bundle, widget_class, *args, **kwargs):
        ...
        """
        return self.__launch_blur_dialog(
            title, bundle, widget_class, True, *args, **kwargs
        )
