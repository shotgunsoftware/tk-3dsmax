...
#
# This work is provided "AS IS" and subject to the Flow Production Tracking
# Source Code License included in this distribution package. See LICENSE.
# By accessing, using, copying or modifying this work you indicate your
# agreement to the Flow Production Tracking Source Code License. All rights
...
class MaxUIConfig(HookClass):
    """Hook to customize customize the main file view for 3ds Max."""
